...
class RatingObject:
    def __init__(self, line):
        ...
        self.nsf_elos, self.games = get_ratings_by_name(str(s[1]))
        self.fide_elos, self.rapid_elos, self.blitz_elos = get_all_fide_ratings(self.fide_id)
        self.nsf_elo = to_int(s[4])
